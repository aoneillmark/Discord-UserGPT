...
dataset_path = 'Results/processed_data/prompt_response_pairs.txt'
prompts = []
responses = []
...
model_save_path = 'Results/models/gpt2-finetuned'
tokenizer_save_path = 'Results/models/gpt2-finetuned'
